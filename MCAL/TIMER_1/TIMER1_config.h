...
#define TIMER1_MODE				NORMAL_MODE //option to select[1-NORMAL_MODE 2-CTC_MODE	3-PHASE_CORRECT_PWM_MODE 4-FAST_PWM_MODE]

#define PWM1_MODE				FAST_PWM_MODE	//option to select[1-PHASE_CORRECT_PWM_MODE 2-FAST_PWM_MODE]

#define COMPARE_OUTPUT_MODE		NON_INVERTED_MODE //option to select[1-INVERTED_MODE 2-NON_INVERTED_MODE]

#define TIMER1_PRESCALAR		64  	//option to select[1-1024	2-512	3-256	4-128	5-64	6-32	7-16	8-8		9-4		10-2]
